...
class ModelFunction : public FunctionProducer<2>
{
public:
    ...
    double operator()(vect<2> const& p) override
    {
        double x2 = sqr(p(0));
        double y2 = sqr(p(1));
    ...
    vect<2> grad(vect<2> const& p) override
    {
        double x = p(0);
        double y = p(1);
        double x2 = sqr(x);
    ...
    matrix<2, 2> hess(vect<2> const& p) override
    {
        double x = p(0);
        double y = p(1);
        double x2 = sqr(x);
...
class SecondModelFunction : public FunctionProducer<2>
{
public:
