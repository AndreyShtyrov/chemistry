...
template<typename Func1T, typename Func2T>
typename enable_if<is_base_of<FunctionProducer, decay_t<Func1T>>::value && is_base_of<FunctionProducer, decay_t<Func2T>>::value, Sum<decay_t<Func1T>, decay_t<Func2T>>>::type
operator+(Func1T&& func1, Func2T&& func2)
{
    return Sum<decay_t<Func1T>, decay_t<Func2T>>(forward<Func1T>(func1), forward<Func2T>(func2));
};
