...
class Product : public FunctionProducer<Func1T::N>
{
public:
...
template<typename Func1T, typename Func2T>
typename enable_if<is_base_of<FunctionProducer<Func1T::N>, Func1T>::value && is_base_of<FunctionProducer<Func1T::N>, Func2T>::value, Product<Func1T, Func2T>>::type
